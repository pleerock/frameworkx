 ...
 */
// export type P extends BlueprintAnyProperty | InputAnyProperty, S extends SelectionSchema<any> | undefined = undefined>
 ...
 *
 */
export type SelectionAliasMap<T, P extends keyof T> = {
    [key: string]:
        ...
        T[P] extends Array<infer I> | null | undefined ? (
            ...
            I extends object | null | undefined ? { name: P, select: BlueprintSelectionWithAliases<I> } :
            I extends string | null | undefined ? { name: P } :
            I extends number | null | undefined ? { name: P } :
            I extends boolean | null | undefined ? { name: P }:
            unknown
        ) :
        T[P] extends object | null | undefined ? { name: P, select: BlueprintSelectionWithAliases<T[P]> } :
        T[P] extends string | null | undefined ? { name: P } :
        T[P] extends number | null | undefined ? { name: P } :
        T[P] extends boolean | null | undefined ? { name: P }:
        unknown
}
...
// type BlueprintTypeBase<T extends Blueprint, S extends SelectionSchema<any> | undefined = undefined> =
//     S extends undefined ? (
//         { [P in keyof BlueprintRequiredKeys<T>]: T[P] extends BlueprintNullable<any> ? never : T[P]>
//         & { [P in keyof BlueprintNullableKeys<T>]?: T[P] extends BlueprintNullable<infer U> ? U> : never
//     ) : (
//           { [P in keyof BlueprintSelectedKeys<BlueprintRequiredKeys<T>, S>]: T[P] extends BlueprintNullable<any> ? never : T[P], S[P]>
//         & { [P in keyof BlueprintSelectedKeys<BlueprintNullableKeys<T>, S>]?: T[P] extends BlueprintNullable<infer U> ? U, S[P]> : never
//     )
 ...
 * "S"  - selection schema
 */
/*export type BlueprintType<T, S extends SelectionSchema<T> | undefined = undefined> =
 ...
 */
export type BlueprintSelectionWithAliases<T> =
{
...
export type MixedModel<M> = M extends Model<infer Blueprint, any> ? Blueprint : M

export type SelectionOf<M extends Model<any, any> | object, Schema extends DeepPartial<MixedModel<M>>> = {
    model: M
    schema: Schema
}
 ...
 */
export type SelectionSchema2<Blueprint> = {
    [P in keyof Blueprint]?: Blueprint[P]
}
export type SelectionSchema<B> = {
    [P in keyof B]?: // todo add BlueprintNullable
        ...
        //     select?: ...
        //     aliases?: ...
        // } maybe alias map example can help here

        B[P] extends null ? never :
        B[P] extends undefined ? never :
        B[P] extends Array<infer I> | null | undefined ? (
            I extends null ? never :
            I extends undefined ? never :
            I extends object | null | undefined ? SelectionSchema<I> | BlueprintSelectionWithAliases<I> :
            unknown
        ) :
        B[P] extends object | null | undefined ? SelectionSchema<B[P]> | BlueprintSelectionWithAliases<B[P]> :
        B[P] extends string | null | undefined ? boolean | { aliases: SelectionAliasMap<B, keyof B> } :
        B[P] extends number | null | undefined ? boolean | { aliases: SelectionAliasMap<B, keyof B> } :
        B[P] extends boolean | null | undefined ? boolean | { aliases: SelectionAliasMap<B, keyof B> } :
        unknown
...
export type AnyBlueprintSelectionType<T, S extends SelectionSchema<any>> =
    T extends BlueprintNullable<infer V> ? (
...
export type BlueprintConditionOption<P> = {
  not?: P
} | {
  lessThan?: P
} | {
...
export type BlueprintOrdering<T> = {
  [P in keyof T]?: "asc" | "desc"
}

export type BlueprintCondition<T> = {
  [P in keyof T]?: T[P] | BlueprintConditionOption<T[P]>
}
