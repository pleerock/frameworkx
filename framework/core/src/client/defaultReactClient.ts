...
export const defaultReactClient = (options: {
  serverUrl: string,
  ...
  return {
    graphqlFetch(query, variables): Promise<any> {

      if (query instanceof Object && query.loc && query.loc.source && query.loc.source.body) {
