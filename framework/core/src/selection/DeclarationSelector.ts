import {ApplicationProperties, DeclarationItem} from "../app";
import {DeclarationSelection, DeclarationSelectorResult, executeQuery} from "../types";
...
export class DeclarationSelector<
  ...
  async fetch(): Promise<DeclarationSelectorResult<Declaration, Selection>> {
    return executeQuery(this.appProperties.client, this.type, this.name as string, this.selection as any, 0)
  }
