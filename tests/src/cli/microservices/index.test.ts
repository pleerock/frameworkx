...
describe("cli > init", () => {
  ...
  test("microservices", async () => {
    ...
    expect(files).toEqual([
      "./_/cli/microservices/app/microservices-test",
      ...
      "./_/cli/microservices/app/microservices-test/packages",
      "./_/cli/microservices/app/microservices-test/packages/category",
      ...
      "./_/cli/microservices/app/microservices-test/packages/category/src",
      "./_/cli/microservices/app/microservices-test/packages/category/src/app",
      ...
      "./_/cli/microservices/app/microservices-test/packages/category/src/app/CategoryDbConnection.ts",
      ...
      "./_/cli/microservices/app/microservices-test/packages/category/src/entity",
      ...
      "./_/cli/microservices/app/microservices-test/packages/category/src/input",
      ...
      "./_/cli/microservices/app/microservices-test/packages/category/src/model",
      "./_/cli/microservices/app/microservices-test/packages/category/src/model-resolver",
      ...
      "./_/cli/microservices/app/microservices-test/packages/category/src/repository",
      ...
      "./_/cli/microservices/app/microservices-test/packages/category/src/root-resolver",
      ...
      "./_/cli/microservices/app/microservices-test/packages/gateway",
      ...
      "./_/cli/microservices/app/microservices-test/packages/gateway/src",
      "./_/cli/microservices/app/microservices-test/packages/gateway/src/app",
      ...
      "./_/cli/microservices/app/microservices-test/packages/gateway/src/fetcher",
      ...
      "./_/cli/microservices/app/microservices-test/packages/gateway/src/input",
      ...
      "./_/cli/microservices/app/microservices-test/packages/gateway/src/model",
      "./_/cli/microservices/app/microservices-test/packages/gateway/src/model-resolver",
      ...
      "./_/cli/microservices/app/microservices-test/packages/gateway/src/root-resolver",
      ...
      "./_/cli/microservices/app/microservices-test/packages/post",
      ...
      "./_/cli/microservices/app/microservices-test/packages/post/src",
      "./_/cli/microservices/app/microservices-test/packages/post/src/app",
      ...
      "./_/cli/microservices/app/microservices-test/packages/post/src/app/PostDbConnection.ts",
      ...
      "./_/cli/microservices/app/microservices-test/packages/post/src/entity",
      ...
      "./_/cli/microservices/app/microservices-test/packages/post/src/input",
      ...
      "./_/cli/microservices/app/microservices-test/packages/post/src/model",
      "./_/cli/microservices/app/microservices-test/packages/post/src/model-resolver",
      ...
      "./_/cli/microservices/app/microservices-test/packages/post/src/repository",
      ...
      "./_/cli/microservices/app/microservices-test/packages/post/src/root-resolver",
      ...
      "./_/cli/microservices/app/microservices-test/packages/post/src/validator",
      ...
      "./_/cli/microservices/app/microservices-test/packages/user",
      ...
      "./_/cli/microservices/app/microservices-test/packages/user/src",
      "./_/cli/microservices/app/microservices-test/packages/user/src/app",
      ...
      "./_/cli/microservices/app/microservices-test/packages/user/src/app/UserDbConnection.ts",
      ...
      "./_/cli/microservices/app/microservices-test/packages/user/src/entity",
      ...
      "./_/cli/microservices/app/microservices-test/packages/user/src/input",
      ...
      "./_/cli/microservices/app/microservices-test/packages/user/src/model",
      "./_/cli/microservices/app/microservices-test/packages/user/src/model-resolver",
      ...
      "./_/cli/microservices/app/microservices-test/packages/user/src/repository",
      ...
      "./_/cli/microservices/app/microservices-test/packages/user/src/root-resolver",
      ...
      "./_/cli/microservices/app/microservices-test/packages/user/src/util",
    ...
    for (let file of files) {
      ...
      if (!stat.isDirectory()) {
        ...
        expect(
          loadedFile.indexOf(
            `from "microframework-template-microservices-post"`,
          ),
        ).toBe(-1)
        expect(
          loadedFile.indexOf(
        ...
        expect(
          loadedFile.indexOf(
            `from "microframework-template-microservices-user"`,
          ),
        ).toBe(-1)
        expect(
          loadedFile.indexOf(
            `from "microframework-template-microservices-root"`,
          ),
        ).toBe(-1)
        expect(
          loadedFile.indexOf(
