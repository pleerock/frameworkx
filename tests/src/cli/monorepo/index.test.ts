...
describe("cli > init", () => {
  ...
  test("monorepo", async () => {
    ...
    expect(files).toEqual([
      "./_/cli/monorepo/app/monorepo-test",
      ...
      "./_/cli/monorepo/app/monorepo-test/packages",
      "./_/cli/monorepo/app/monorepo-test/packages/client",
      "./_/cli/monorepo/app/monorepo-test/packages/client/.gitignore",
      "./_/cli/monorepo/app/monorepo-test/packages/client/package.json",
      "./_/cli/monorepo/app/monorepo-test/packages/client/public",
      ...
      "./_/cli/monorepo/app/monorepo-test/packages/client/src",
      ...
      "./_/cli/monorepo/app/monorepo-test/packages/common/src/model",
      ...
      "./_/cli/monorepo/app/monorepo-test/packages/server",
      "./_/cli/monorepo/app/monorepo-test/packages/server/.env",
      "./_/cli/monorepo/app/monorepo-test/packages/server/package.json",
      "./_/cli/monorepo/app/monorepo-test/packages/server/src",
      "./_/cli/monorepo/app/monorepo-test/packages/server/src/app",
      ...
      "./_/cli/monorepo/app/monorepo-test/packages/server/src/entity",
      ...
      "./_/cli/monorepo/app/monorepo-test/packages/server/src/model-resolver",
      ...
      "./_/cli/monorepo/app/monorepo-test/packages/server/src/repository",
      ...
      "./_/cli/monorepo/app/monorepo-test/packages/server/src/root-resolver",
      ...
      "./_/cli/monorepo/app/monorepo-test/packages/server/src/validator",
